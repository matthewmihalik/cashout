...
const DEFAULTS = () => ({
  ...
  permFunds: [
    { id:'roth',   emoji:'🏦', name:'Roth IRA',         pct:0, mode:'pct', amount:0, balance:0, account:'fid-roth', linkTo:'' },
    { id:'travel', emoji:'✈️', name:'Travel Fund',      pct:0, mode:'pct', amount:0, balance:0, account:'fid-travel', linkTo:'' },
    { id:'emerg',  emoji:'🚨', name:'Emergency Fund',   pct:0, mode:'pct', amount:0, balance:0, account:'cfcu', linkTo:'' },
    { id:'gen',    emoji:'💰', name:'General Savings',  pct:0, mode:'pct', amount:0, balance:0, account:'cfcu', linkTo:'' },
    { id:'home',   emoji:'🔧', name:'Home / Repairs',   pct:0, mode:'pct', amount:0, balance:0, account:'cfcu', linkTo:'' },
    { id:'health', emoji:'💊', name:'Health Reserve',   pct:0, mode:'pct', amount:0, balance:0, account:'cfcu', linkTo:'' },
  ],
  weeklyFunds: [
    { id:'groc',  emoji:'🛒', name:'Groceries',       budget:0, mode:'fixed' },
    { id:'eat',   emoji:'🍔', name:'Eating Out',      budget:0, mode:'fixed' },
    { id:'fun',   emoji:'🎉', name:'Fun / Personal',  budget:0, mode:'fixed' },
    { id:'cloth', emoji:'👗', name:'Clothing',        budget:0, mode:'fixed' },
    { id:'pets',  emoji:'🐾', name:'Pets',            budget:0, mode:'fixed' },
    { id:'self',  emoji:'💆', name:'Self Care',       budget:0, mode:'fixed' },
    { id:'gift',  emoji:'🎁', name:'Gifts',           budget:0, mode:'fixed' },
    { id:'gas',   emoji:'🚗', name:'Gas / Transport', budget:0, mode:'fixed' },
    { id:'other', emoji:'📦', name:'Other',           budget:0, mode:'fixed' },
  ],
  bills: [
    { id:'car',   emoji:'🚗', name:'Car Payment',    amount:0, period:'month', dueDay:1 },
    { id:'rent',  emoji:'🏠', name:'Rent / Housing', amount:0, period:'month', dueDay:1 },
    { id:'phone', emoji:'📱', name:'Phone Bill',     amount:0, period:'month', dueDay:15 },
    { id:'util',  emoji:'⚡', name:'Utilities',      amount:0, period:'month', dueDay:20 },
    { id:'net',   emoji:'🌐', name:'Internet',       amount:0, period:'month', dueDay:20 },
    { id:'ins',   emoji:'🛡️', name:'Insurance',      amount:0, period:'month', dueDay:25 },
  ],
  accounts: [
  ...
  remindHour: 21,
  remindEnabled: true,   // daily shift reminder (turn off for a shared/joint budget)
  closeDay: 0, // Sunday
});
